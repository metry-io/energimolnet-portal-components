...
.directive('emPagination', function() {
  return {
    restrict: 'E',
    template: '<div class="text-center" ng-show="!resMgr.loading && resMgr.data.length > 0">' +
              ...
              '<p ng-if=":: ctrl.lang === \'en\'">Showing from {{ resMgr.pagination.from }} to {{ resMgr.pagination.to }} of {{ resMgr.pagination.count }} matches</p>' +
